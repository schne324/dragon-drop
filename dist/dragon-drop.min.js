...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),_dragula=require("dragula"),_dragula2=_interopRequireDefault(_dragula),_liveRegion=require("live-region"),_liveRegion2=_interopRequireDefault(_liveRegion),_closest=require("closest"),_closest2=_interopRequireDefault(_closest),_delegate=require("delegate"),_delegate2=_interopRequireDefault(_delegate),_mergeOptions=require("merge-options"),_mergeOptions2=_interopRequireDefault(_mergeOptions),_debug=require("debug"),_debug2=_interopRequireDefault(_debug),_componentEmitter=require("component-emitter"),_componentEmitter2=_interopRequireDefault(_componentEmitter),_defaults=require("./lib/defaults"),_defaults2=_interopRequireDefault(_defaults),_queryAll=require("./lib/query-all"),_queryAll2=_interopRequireDefault(_queryAll),debug=(0,_debug2.default)("drag-on-drop:index"),DragonDrop=function(){function e(t,n){return _classCallCheck(this,e),(0,_componentEmitter2.default)(this),this.dragula=(0,_dragula2.default)([t]),this.liveRegion=new _liveRegion2.default({ariaLive:"assertive",ariaRelevant:"additions",ariaAtomic:"true"}),this.onKeydown=this.onKeydown.bind(this),this.initOptions(n).initElements(t).mouseEvents().initClick(),debug("dragon initialized: ",this),this}return _createClass(e,[{key:"initOptions",value:function(e){return e=e||{},e.announcement=e.announcement||{},this.options=(0,_mergeOptions2.default)({},_defaults2.default,e),this}},{key:"initClick",value:function(){var e=this,t=this.options,n=t.activeClass,i=t.inactiveClass,r=t.item,a=this.options.handle?r+" "+this.options.handle:r;return(0,_delegate2.default)(this.container,a,"click",function(t){var a=t.delegateTarget,o="true"===a.getAttribute("data-drag-on"),s=o?"dropped":"grabbed";e.handles.filter(function(e){return"true"===e.getAttribute("aria-pressed")}).forEach(function(e){e.setAttribute("aria-pressed","false"),e.setAttribute("data-drag-on","false"),e.classList.remove(n)}),a.setAttribute("aria-pressed",""+!o),a.setAttribute("data-drag-on",""+!o);var u=(0,_closest2.default)(a,r,!0);e.announcement(s,u),e.emit(s,e.container,u),e.items.forEach(function(e){var t=o?"remove":"add",r=e===a||e.contains(a);e.classList[r&&!o?"add":"remove"](n),e.classList[r&&!o?"remove":t](i)}),o||(e.cachedItems=(0,_queryAll2.default)(e.options.item,e.container))}),this}},{key:"initElements",value:function(e){var t=this;return this.container=e,this.setItems(),this.handles.forEach(function(e){e.tabIndex=0,"BUTTON"!==e.tagName&&e.setAttribute("role","button"),e.removeEventListener("keydown",t.onKeydown),e.addEventListener("keydown",t.onKeydown)}),this}},{key:"setItems",value:function(){var e=this.options;return this.items=(0,_queryAll2.default)(e.item,this.container),this.handles=e.handle?(0,_queryAll2.default)([e.item,e.handle].join(" "),this.container):this.items,this}},{key:"onKeydown",value:function(e){var t=e.target,n=e.which,i=function(){return"true"===t.getAttribute("data-drag-on")};switch(n){case 13:case 32:e.preventDefault(),t.click();break;case 37:case 38:case 39:case 40:i()&&(e.preventDefault(),this.arrow(n,t));break;case 9:i()&&t.click();break;case 27:i()&&(t.click(),this.cancel())}return this}},{key:"arrow",value:function(e,t){var n=this.handles,i=this.items,r=37===e||38===e,a=n.indexOf(t),o=r?a-1:a+1;if(n[o]){var s=i[a],u=i[o],l=r?u:u.nextElementSibling;return s.parentNode.insertBefore(s,l),t.focus(),this.setItems().emit("reorder",this.container,s).announcement("reorder",s),this}}},{key:"announcement",value:function(e,t){debug(e+" announcement",t);var n=(this.options.announcement||{})[e];if(n&&"function"==typeof n){var i=n(t,this.items);this.liveRegion.announce(i,5e3),this.emit("announcement",i)}return this}},{key:"mouseEvents",value:function(){var e=this;return this.dragula.on("drag",function(t){e.announcement("grabbed",t)}),this.dragula.on("drop",function(t){e.announcement("dropped",t).setItems()}),this}},{key:"cancel",value:function(){var e=this,t=document.activeElement;return this.cachedItems.forEach(function(t){return e.container.appendChild(t)}),this.items=this.cachedItems,t.focus(),this.announcement("cancel").emit("cancel").setItems(),this}}]),e}();exports.default=DragonDrop,module.exports=DragonDrop;
...
(function (global){
"use strict";function dragula(e,t){function n(e){return-1!==H.containers.indexOf(e)||I.isContainer(e)}function o(e){var t=e?"remove":"add";touchy(documentElement,t,"mousedown",function(e){T=e.clientX,O=e.clientY;if(1!==whichMouseButton(e)||e.metaKey||e.ctrlKey)return;var t=e.target,n=u(t);if(!n)return;Y=n,r(),"mousedown"===e.type&&(isInput(t)?t.focus():e.preventDefault())}),touchy(documentElement,t,"mouseup",s)}function r(e){touchy(documentElement,e?"remove":"add","mousemove",function(e){if(!Y)return;if(0===whichMouseButton(e))return void s({});if(void 0!==e.clientX&&e.clientX===T&&void 0!==e.clientY&&e.clientY===O)return;if(I.ignoreInputTextSelection){var t=getCoord("clientX",e),n=getCoord("clientY",e);if(isInput(doc.elementFromPoint(t,n)))return}var o=Y;r(!0),i(),a(),l(o);var c=getOffset(b);w=getCoord("pageX",e)-c.left,x=getCoord("pageY",e)-c.top,classes.add(R||b,"gu-transit"),function(){if(C)return;var e=b.getBoundingClientRect();(C=b.cloneNode(!0)).style.width=getRectWidth(e)+"px",C.style.height=getRectHeight(e)+"px",classes.rm(C,"gu-transit"),classes.add(C,"gu-mirror"),I.mirrorContainer.appendChild(C),touchy(documentElement,"add","mousemove",E),classes.add(I.mirrorContainer,"gu-unselectable"),H.emit("cloned",C,b,"mirror")}(),E(e)})}function i(e){var t=e?"remove":"add";crossvent[t](documentElement,"selectstart",c),crossvent[t](documentElement,"click",c)}function c(e){Y&&e.preventDefault()}function u(e){if(!(H.dragging&&C||n(e))){for(var t=e;getParent(e)&&!1===n(getParent(e));){if(I.invalid(e,t))return;if(!(e=getParent(e)))return}var o=getParent(e);if(o&&!I.invalid(e,t)){if(I.moves(e,o,t,nextEl(e)))return{item:e,source:o}}}}function l(e){(function(e,t){return"boolean"==typeof I.copy?I.copy:I.copy(e,t)})(e.item,e.source)&&(R=e.item.cloneNode(!0),H.emit("cloned",R,e.item,"copy")),P=e.source,b=e.item,B=N=nextEl(e.item),H.dragging=!0,H.emit("drag",b,P)}function a(){if(H.dragging){var e=R||b;g(e,getParent(e))}}function d(){Y=!1,r(!0),i(!0)}function s(e){if(d(),H.dragging){var t=R||b,n=getCoord("clientX",e),o=getCoord("clientY",e),r=p(getElementBehindPoint(C,n,o),n,o);r&&(R&&I.copySortSource||!R||r!==P)?g(t,r):I.removeOnSpill?m():v()}}function g(e,t){var n=getParent(e);R&&I.copySortSource&&t===P&&n.removeChild(b),h(t)?H.emit("cancel",e,P,P):H.emit("drop",e,t,P,N),f()}function m(){if(H.dragging){var e=R||b,t=getParent(e);t&&t.removeChild(e),H.emit(R?"cancel":"remove",e,t,P),f()}}function v(e){if(H.dragging){var t=arguments.length>0?e:I.revertOnSpill,n=R||b,o=getParent(n),r=h(o);!1===r&&t&&(R?o&&o.removeChild(R):P.insertBefore(n,B)),r||t?H.emit("cancel",n,P,P):H.emit("drop",n,o,P,N),f()}}function f(){var e=R||b;d(),C&&(classes.rm(I.mirrorContainer,"gu-unselectable"),touchy(documentElement,"remove","mousemove",E),getParent(C).removeChild(C),C=null),e&&classes.rm(e,"gu-transit"),X&&clearTimeout(X),H.dragging=!1,M&&H.emit("out",e,M,P),H.emit("dragend",e),P=b=R=B=N=X=M=null}function h(e,t){var n;return n=void 0!==t?t:C?N:nextEl(R||b),e===P&&n===B}function p(e,t,o){for(var r=e;r&&!function(){if(!1===n(r))return!1;var i=y(r,e),c=S(r,i,t,o);return!!h(r,c)||I.accepts(b,r,P,c)}();)r=getParent(r);return r}function E(e){function t(e){H.emit(e,c,M,P)}if(C){e.preventDefault();var n=getCoord("clientX",e),o=getCoord("clientY",e),r=n-w,i=o-x;C.style.left=r+"px",C.style.top=i+"px";var c=R||b,u=getElementBehindPoint(C,n,o),l=p(u,n,o),a=null!==l&&l!==M;(a||null===l)&&(M&&t("out"),M=l,a&&t("over"));var d=getParent(c);if(l!==P||!R||I.copySortSource){var s,g=y(l,u);if(null!==g)s=S(l,g,n,o);else{if(!0!==I.revertOnSpill||R)return void(R&&d&&d.removeChild(c));s=B,l=P}(null===s&&a||s!==c&&s!==nextEl(c))&&(N=s,l.insertBefore(c,s),H.emit("shadow",c,l,P))}else d&&d.removeChild(c)}}function y(e,t){for(var n=t;n!==e&&getParent(n)!==e;)n=getParent(n);return n===documentElement?null:n}function S(e,t,n,o){function r(e){return e?nextEl(t):t}var i="horizontal"===I.direction;return t!==e?function(){var e=t.getBoundingClientRect();return r(i?n>e.left+getRectWidth(e)/2:o>e.top+getRectHeight(e)/2)}():function(){var t,r,c,u=e.children.length;for(t=0;t<u;t++){if(r=e.children[t],c=r.getBoundingClientRect(),i&&c.left+c.width/2>n)return r;if(!i&&c.top+c.height/2>o)return r}return null}()}1===arguments.length&&!1===Array.isArray(e)&&(t=e,e=[]);var C,P,b,w,x,T,O,B,N,R,X,Y,M=null,I=t||{};void 0===I.moves&&(I.moves=always),void 0===I.accepts&&(I.accepts=always),void 0===I.invalid&&(I.invalid=function(){return!1}),void 0===I.containers&&(I.containers=e||[]),void 0===I.isContainer&&(I.isContainer=never),void 0===I.copy&&(I.copy=!1),void 0===I.copySortSource&&(I.copySortSource=!1),void 0===I.revertOnSpill&&(I.revertOnSpill=!1),void 0===I.removeOnSpill&&(I.removeOnSpill=!1),void 0===I.direction&&(I.direction="vertical"),void 0===I.ignoreInputTextSelection&&(I.ignoreInputTextSelection=!0),void 0===I.mirrorContainer&&(I.mirrorContainer=doc.body);var H=emitter({containers:I.containers,start:function(e){var t=u(e);t&&l(t)},end:a,cancel:v,remove:m,destroy:function(){o(!0),s({})},canMove:function(e){return!!u(e)},dragging:!1});return!0===I.removeOnSpill&&H.on("over",function(e){classes.rm(e,"gu-hide")}).on("out",function(e){H.dragging&&classes.add(e,"gu-hide")}),o(),H}function touchy(e,t,n,o){var r={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},i={mouseup:"pointerup",mousedown:"pointerdown",mousemove:"pointermove"},c={mouseup:"MSPointerUp",mousedown:"MSPointerDown",mousemove:"MSPointerMove"};global.navigator.pointerEnabled?crossvent[t](e,i[n],o):global.navigator.msPointerEnabled?crossvent[t](e,c[n],o):(crossvent[t](e,r[n],o),crossvent[t](e,n,o))}function whichMouseButton(e){if(void 0!==e.touches)return e.touches.length;if(void 0!==e.which&&0!==e.which)return e.which;if(void 0!==e.buttons)return e.buttons;var t=e.button;return void 0!==t?1&t?1:2&t?3:4&t?2:0:void 0}function getOffset(e){var t=e.getBoundingClientRect();return{left:t.left+getScroll("scrollLeft","pageXOffset"),top:t.top+getScroll("scrollTop","pageYOffset")}}function getScroll(e,t){return void 0!==global[t]?global[t]:documentElement.clientHeight?documentElement[e]:doc.body[e]}function getElementBehindPoint(e,t,n){var o,r=e||{},i=r.className;return r.className+=" gu-hide",o=doc.elementFromPoint(t,n),r.className=i,o}function never(){return!1}function always(){return!0}function getRectWidth(e){return e.width||e.right-e.left}function getRectHeight(e){return e.height||e.bottom-e.top}function getParent(e){return e.parentNode===doc?null:e.parentNode}function isInput(e){return"INPUT"===e.tagName||"TEXTAREA"===e.tagName||"SELECT"===e.tagName||isEditable(e)}function isEditable(e){return!!e&&("false"!==e.contentEditable&&("true"===e.contentEditable||isEditable(getParent(e))))}function nextEl(e){return e.nextElementSibling||function(){var t=e;do{t=t.nextSibling}while(t&&1!==t.nodeType);return t}()}function getEventHost(e){return e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:e}function getCoord(e,t){var n=getEventHost(t),o={pageX:"clientX",pageY:"clientY"};return e in o&&!(e in n)&&o[e]in n&&(e=o[e]),n[e]}var emitter=require("contra/emitter"),crossvent=require("crossvent"),classes=require("./classes"),doc=document,documentElement=doc.documentElement;module.exports=dragula;
